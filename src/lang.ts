const lang = {
  ...
  "ChatList.Main.EmptyPlaceholder.Subtitle": "You have %s on Connect | Collaborate | Communicate ",
  "ChatList.Main.EmptyPlaceholder.SubtitleNoContacts": "Use Connect | Collaborate | Communicate  app on your [Android](https://telegram.org/android) or [iOS](https://telegram.org/dl/ios) device to sync your contacts",
  ...
  "Deactivated.Subtitle": "Connect | Collaborate | Communicate  supports only one active tab with the app.\nClick anywhere to continue using this tab.",
  // "Drafts": {
  //   "one_value": "%d draft",
  ...
  "Message.Unsupported.Desktop": "__This message is currently not supported on Connect | Collaborate | Communicate  Web. Try [getdesktop.telegram.org](https://getdesktop.telegram.org/)__",
  "Message.Unsupported.Mobile": "__This message is currently not supported on Connect | Collaborate | Communicate  Web. Try [telegram.org/dl](https://telegram.org/dl/)__",
  ...
  "LogOut.Description": "Are you sure you want to log out?\n\nNote that you can seamlessly use Connect | Collaborate | Communicate  on all your devices at once.",
  ...
  "ContactJoined": "Contact joined Connect | Collaborate | Communicate ",
  "Loading": "Loading...",
  "Unblock": "Unblock",
  ...
  "PrivacyPhoneInfo": "Users who have your number saved in their contacts will also see it on Connect | Collaborate | Communicate .",
  "PrivacyPhoneInfo3": "Users who add your number to their contacts will see it on Connect | Collaborate | Communicate  only if they are your contacts.",
  ...
  "YourEmailSkipWarningText": "No, seriously.\n\nIf you forget your password, you will lose access to your Connect | Collaborate | Communicate  account. There will be no way to restore it.",
  ...
  "TelegramFeatures": "Connect | Collaborate | Communicate  Features",
  ...
  "NoUsernameFound": "There is no Connect | Collaborate | Communicate  account with this username.",
  ...
  "AppName": "Connect | Collaborate | Communicate ",
  "OK": "OK",
  ...
  "ReportSentInfo": "Connect | Collaborate | Communicate  moderators will review your report.\nThank you for your cooperation!",
  ...
  "SessionsListInfo": "The official Connect | Collaborate | Communicate  app is available for Android, iPhone, iPad, Windows, macOS and Linux.",
  ...
  "Contacts.PhoneNumber.NotRegistred": "The person with this phone number is not registered on Connect | Collaborate | Communicate  yet.",
  "Channel.UsernameAboutChannel": "People can share this link with others and can find your channel using Connect | Collaborate | Communicate  search.",
  "Channel.UsernameAboutGroup": "People can share this link with others and find your group using Connect | Collaborate | Communicate  search.",
  ...
  "Chat.Service.PeerJoinedTelegram": "%@ joined Connect | Collaborate | Communicate ",
  ...
  "Chat.Message.Ad.Text": "Unlike other apps, Connect | Collaborate | Communicate  never uses your private data to target ads. Sponsored messages on Connect | Collaborate | Communicate  are based solely on the topic of the public channels in which they are shown. This means that no user data is mined or analyzed to display ads, and every user viewing a channel on Connect | Collaborate | Communicate  sees the same sponsored messages.\n\nUnlike other apps, Connect | Collaborate | Communicate  doesn't track whether you tapped on a sponsored message and doesn't profile you based on your activity. We also prevent external links in sponsored messages to ensure that third parties can’t spy on our users. We believe that everyone has the right to privacy, and technological platforms should respect that.\n\nConnect | Collaborate | Communicate  offers a free and unlimited service to hundreds of millions of users, which involves significant server and traffic costs. In order to remain independent and stay true to its values, Connect | Collaborate | Communicate  developed a paid tool to promote messages with user privacy in mind. We welcome responsible advertisers at:\n\n%@\n\nSponsored Messages are currently in test mode. Once they are fully launched and allow Connect | Collaborate | Communicate  to cover its basic costs, we will start sharing ad revenue with the owners of public channels in which sponsored messages are displayed.\n\nOnline ads should no longer be synonymous with abuse of user privacy. Let us redefine how a tech company should operate – together.",
  ...
  "PrivacyAndSecurity.SensitiveDesc": "Display sensitive media in public channels on all your Connect | Collaborate | Communicate  devices.",
  ...
  "PrivacySettingsController.P2p.Desc": "Disabling peer-to-peer will relay all calls through Connect | Collaborate | Communicate  servers to avoid revealing your IP address, but may slightly decrease audio and video quality.",
  ...
  "TwoStepAuth.GenericHelp": "You have enabled Two-Step verification.\nYou'll need the password you set up here to log in to your Connect | Collaborate | Communicate  account.",
  ...
  "UsernameSettings.ChangeDescription": "You can choose a username on Connect | Collaborate | Communicate . If you do, people will be able to find you by this username and contact you without needing your phone number.\n\n\nYou can use a-z, 0-9 and underscores. Minimum length is 5 characters.",
