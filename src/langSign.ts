const lang = {
  "Login.Title": "Sign in to Connect | Collaborate | Communicate",
  ...
  "Login.Code.SentInApp": "We have sent you a message in Connect | Collaborate | Communicate\nwith the code.",
  ...
  "Login.QR.Title": "Log in to Connect | Collaborate | Communicate by QR Code",
  "Login.QR.Help1": "Open Connect | Collaborate | Communicate on your phone",
